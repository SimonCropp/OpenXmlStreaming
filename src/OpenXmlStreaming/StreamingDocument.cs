...
public static class StreamingDocument
{
    ...
    /// </summary>
    public static OpenXmlPackageWriter CreateWord(Stream stream, WordprocessingDocumentType type, bool leaveOpen = false)
    {
        _ = type;
    ...
    /// </summary>
    public static OpenXmlPackageWriter CreateSpreadsheet(Stream stream, SpreadsheetDocumentType type, bool leaveOpen = false)
    {
        _ = type;
        var writer = new OpenXmlPackageWriter(stream, leaveOpen);
    ...
    /// </summary>
    public static OpenXmlPackageWriter CreatePresentation(Stream stream, PresentationDocumentType type, bool leaveOpen = false)
    {
        _ = type;
        var writer = new OpenXmlPackageWriter(stream, leaveOpen);
